      ...
      <div>
        <Router>
          ...
          <Routes>
            ...
            <Route exact path="/entertaiment" element={<News setProgress={setProgress} apiKey={apiKey} key="entertaiment" pageSize={pageSize} country="us" category="entertaiment" />} />
